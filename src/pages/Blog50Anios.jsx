      ...
      <main className="container py-4">
        ...
        <article className="mx-auto" style={{ maxWidth: 900 }}>
          ...
          <header className="mb-2">
            ...
            <p>Hace 50 años celebramos la vida con recetas que combinan técnica, cariño y materias primas de calidad. Nuestra historia está hecha de hitos compartidos con la comunidad, como la colaboración en la torta más grande del mundo (1995), un desafío que nos enseñó que la repostería también une voluntades.
             Hoy seguimos esa misma ruta, pero con nuevas herramientas: una experiencia online cuidada, contenido para inspirarte y un servicio que lleva nuestros postres a tu mesa con el mismo estándar artesanal de siempre. Tradición y modernidad conviven en cada torta, cada galleta y cada detalle.</p>
            <p>Explora cómo combinamos tradición, calidad y comunidad para crear experiencias memorables.</p>
      
            <p><strong>Apendizaje que endulza el futuro</strong> </p>
            <p>Apoyamos a estudiantes con talleres, prácticas y recursos gratuitos para que conviertan su pasión por la pastelería en una carrera.</p>
