...
// Utilidad para agrupar en n columnas por slide
    ...
    <>
          ...
          <div className="row align-items-center g-4">
            <div className="col-12 col-md-6">
              ...
              <p className="lead">
                ...
                Descubre nuestras tortas y postres artesanales.
              </p>
            </div>
            <div className="col-12 col-md-6">
      ...
      <main className="py-5">
        <Container>
          ...
          <Carousel interval={7000} pause="hover" indicators>
                    ...
                    <Col md={4} key={producto.codigo}>
                      <Card className="h-100 shadow-sm">
                        ...
                        <Card.Body className="d-flex flex-column">
                          ...
                          <Button className="btn-choco mt-auto">Agregar al carrito</Button>
                        </Card.Body>
                      </Card>
                    </Col>
                  ))}
